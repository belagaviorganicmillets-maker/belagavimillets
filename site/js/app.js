...
function productCardHTML(p, isCombo) {
  ...
  // "coming-soon" is now treated as available for ordering.
  const orderable =
  ...
  if (availability === "coming-soon") {
    badgeHTML =
      `<span class="product-badge coming-soon-badge">Available</span>`;
...
function renderProducts() {
  ...
  productGrid
    ...
    .forEach((card, idx) => {
      ...
      // Only sold-out products are non-orderable.
      if (p.availability === "sold-out") {
        return;
      }
